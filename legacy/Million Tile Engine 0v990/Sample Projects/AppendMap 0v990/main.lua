...
for y = 1, 10, 1 do
	if y < 4 then
		for x = 1, 10, 1 do
			...
			if toggle == 1 then
				mte.appendMap("map/House1.tmx", nil, (x - 5) * 16 + 1, (y - 5) * 16 + 1, nil, true)
			elseif toggle == 2 then
				mte.appendMap("map/House2.tmx", nil, (x - 5) * 16 + 1, (y - 5) * 16 + 1, nil, true)
			else
				mte.appendMap("map/Fountain.tmx", nil, (x - 5) * 16 + 1, (y - 5) * 16 + 1, nil, true)
			end
		end
	elseif y == 4 then
		for x = 1, 10, 1 do
			if x == 2 or x == 5 or x == 8 then
				mte.appendMap("map/wallStairs.tmx", nil, (x - 5) * 16 + 1, (y - 5) * 16 + 1, nil, true)
			else
				mte.appendMap("map/wallHorizontal.tmx", nil, (x - 5) * 16 + 1, (y - 5) * 16 + 1, nil, true)
			end
		end
	elseif y > 4 then
		for x = 1, 10, 1 do
			...
			if toggle <= 4 then
				mte.appendMap("map/Farm.tmx", nil, (x - 5) * 16 + 1, (y - 5) * 16 + 1, nil, true)
...
local Dpad = display.newImageRect("Dpad.png", 200, 200)
Dpad.x = display.screenOriginX + 100
Dpad.y = display.contentHeight - display.screenOriginY - 100
