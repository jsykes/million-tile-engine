...
mte.loadMap("map/CastleDemo3.tmx")
mte.setCamera({ locX = 30, locY = 45, blockScaleX = 64, blockScaleY = 64})
...
DpadUp = display.newRect(controlGroup, DpadBack.x - 0, DpadBack.y - 62, 75, 75)
DpadDown = display.newRect(controlGroup, DpadBack.x - 0, DpadBack.y + 62, 75, 75)
DpadLeft = display.newRect(controlGroup, DpadBack.x - 62, DpadBack.y - 0, 75, 75)
DpadRight = display.newRect(controlGroup, DpadBack.x + 62, DpadBack.y - 0, 75, 75)
DpadBack:toFront()
...
local spriteSheet2 = graphics.newImageSheet("sentry.png", {width = 32, height = 64, numFrames = 3})
local sequenceData2 = {
