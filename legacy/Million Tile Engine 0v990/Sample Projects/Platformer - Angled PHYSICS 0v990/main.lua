...
--mte.loadMap("map/AngledPhysics1.tmx") 
--mte.loadMap("map/AngledPhysics2.tmx") --Demonstrates physics collision filters
mte.loadMap("map/AngledPhysics3.tmx") --Demonstrates polygon, polyline, ellipse, and square/box object physics
--mte.loadMap("map/AngledPhysics4.tmx") --Demonstrates PhysicsEditor support
local blockScale = 72
local locX = 58
local locY = 19
...
local player = display.newImageRect("playerRect.png", 30, 60)
...
local backdrop = display.newImageRect("CaveBackdrop2.png", 1696, 1600)
setup.layer = 1
