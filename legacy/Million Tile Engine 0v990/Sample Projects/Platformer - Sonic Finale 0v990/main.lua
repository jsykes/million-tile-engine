...
local backDropTop, backDropBottom
backDropTop = display.newRect(display.viewableContentWidth * 0.5, display.viewableContentHeight * 0.25, 
	display.viewableContentWidth, display.viewableContentHeight * 0.5
)
backDropBottom = display.newRect(display.viewableContentWidth * 0.5, display.viewableContentHeight * 0.75, 
	display.viewableContentWidth, display.viewableContentHeight * 0.5
)
backDropTop:setFillColor(0.12549, 0, 0.74118)
backDropBottom:setFillColor(0, 0.58040, 0.99608)

--LOAD MAP -----------------------------------------------------------------------------
mte.toggleWorldWrapX(true)
mte.toggleWorldWrapY(true)
local map = mte.loadMap("map/SonicFinale.tmx")
local blockScale = 350
local locX = 4
local locY = 14
...
local DpadBack = display.newImageRect(controlGroup, "Dpad.png", 240, 240)
DpadBack.x = 140
DpadBack.y = display.viewableContentHeight - 140
DpadBack.alpha = 0.7
local jumpBtn = display.newRect(controlGroup, display.viewableContentWidth - 150, display.viewableContentHeight - 150, 125, 125)
jumpBtn.alpha = 0.6
DpadBack:toFront()

--CREATE PLAYER SPRITE -----------------------------------------------------------------
local spriteSheet = graphics.newImageSheet("SonicSprite2.png", {width = 64, height = 70, numFrames = 224})
local sequenceData = {
