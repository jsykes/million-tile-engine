...
local function gameLoop( event )
    ...
    if not changeMap then
        ...
        composer.gotoScene("IsometricComposer.scene", {effect = "fade", time = 1000})
    end
end
...
function scene:show(event)
    ...
    if event.phase == "will" then
        ...
        mte.isoSort = 1
        mte.loadTileSet("tiled_cave_2", "IsometricComposer/map/tilesets/tiled_cave_2.png")
        mte.loadTileSet("iso-64x64-outside", "IsometricComposer/map/tilesets/iso-64x64-outside.png")
        mte.loadMap("IsometricComposer/map/"..myData.nextMap..".tmx")
        ...
        local spriteSheet = graphics.newImageSheet("IsometricComposer/SirFudnik.png", {width = 128, height = 128, numFrames = 96})
        local sequenceData = {
