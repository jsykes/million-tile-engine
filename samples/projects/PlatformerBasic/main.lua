...
mte.loadMap("PlatformerBasic/map/Basic.tmx")
...
local DpadBack = display.newImageRect(controlGroup, "PlatformerBasic/Dpad.png", 120, 120)
...
local player = display.newImageRect("PlatformerBasic/playerRect.png", 30, 60)
...
local backdrop = display.newImageRect("PlatformerBasic/CaveBackdrop2.png", 1696, 1600)
setup.layer = 1
